...
export const LandingPage: React.FC<LandingPageProps> = ({ onEnterApp }) => {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
      ...
      <a 
        href="https://wa.me/5554991680204?text=Falar%20com%20o%20desenvolvedor%20" 
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:bg-[#128C7E] hover:scale-105 transition-all duration-300 group animate-fade-in-up delay-300"
      >
        ...
        <span className="font-bold hidden md:inline">Fale com Desenvolvedor</span>
      </a>
    </div>
  );
};